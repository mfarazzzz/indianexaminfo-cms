...
// ── Label normalization ────────────────────────────────────────────────────
// Moved to a pure, SDK-free module (src/lib/dates/normalizeLabel.ts) so Excel
// import / preview can share the ONE source without pulling the Gemini SDK into
// their bundle. Imported for internal use here AND re-exported for existing callers.
import { normalizeLabel, TENTATIVE_SIGNALS, type NormalizedDate } from "@/lib/dates/normalizeLabel";
export { normalizeLabel, TENTATIVE_SIGNALS, type NormalizedDate };
